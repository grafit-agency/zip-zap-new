...
const schema = z.object({
  full_name: z.string().min(1, "AT LEAST 1 CHARACTER"),
...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 relative">
        ...
        <div className="flex flex-col items-center gap-8">
          <div className="flex flex-col items-center text-center justify-center gap-8 p-16 relative max-w-[40rem] w-[100%] h-[100%] aspect-square">
            <div className="flex flex-row align-top justify-between max-h-[2.5rem] w-full max-w-[25.125rem]">
              <div className="text-[3rem] text-white relative z-20 leading-[normal]">REGISTER</div>
            ...
            <div className="relative z-20 w-full max-w-[25.125rem] flex flex-col gap-4">
              <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                <div className="space-y-1 flex flex-col align-top justify-start items-start">
                  <Label htmlFor="full_name" className="text-white uppercase text-[1.5rem] font-bold tracking-wider">Username:</Label>
                  <Input 
                    id="full_name" 
                    {...register("full_name")} 
      ...
      <img src="/assety/bg_home/bg_login.png" alt="Background" className="absolute top-0 left-0 w-full h-full bg-image" />
    </div>
  );
};
